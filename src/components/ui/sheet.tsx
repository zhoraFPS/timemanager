...
function SheetOverlay({ className, ...props }: SheetPrimitive.Backdrop.Props) {
  return (
    <SheetPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 z-50 bg-black/35 transition-all duration-[450ms] [transition-timing-function:cubic-bezier(0.32,0.72,0,1)] data-ending-style:opacity-0 data-starting-style:opacity-0 supports-backdrop-filter:bg-black/20 supports-backdrop-filter:backdrop-blur-md data-ending-style:supports-backdrop-filter:backdrop-blur-none data-starting-style:supports-backdrop-filter:backdrop-blur-none",
        className
      )}
      {...props}
    />
